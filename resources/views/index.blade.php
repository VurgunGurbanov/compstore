                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="text-bg">
                                        ...
                                        <a href="#">Buy Now </a> <a href="{{route('contact')}}">Contact </a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="text_img">
    ...
    <div class="three_box">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="box_text">
                        <i><img src="{{asset('images/thr.png')}}" alt="#"/></i>
                        <h3>Computer</h3>
                ...
                <div class="col-md-4">
                    <div class="box_text">
                        <i><img src="{{asset('images/thr1.png')}}" alt="#"/></i>
                        <h3>Laptop</h3>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="box_text">
                        <i><img src="{{asset('images/thr2.png')}}" alt="#"/></i>
                        <h3>Tablet</h3>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="{{asset('images/product1.png')}}" alt="#"/></figure>
                                    <h3>Computer</h3>
                                </div>
                            </div>
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="{{asset('images/product2.png')}}" alt="#"/></figure>
                                    <h3>Laptop</h3>
                                </div>
                            </div>
                            <div class="col-md-4 margin_bottom1">
                            ...
                            <div class="col-md-4 margin_bottom1">
                                <div class="product_box">
                                    <figure><img src="{{asset('images/product5.png')}}" alt="#"/></figure>
                                    <h3>internet</h3>
                                </div>
                            </div>
                            <div class="col-md-4 margin_bottom1">
                            ...
                            <div class="col-md-4">
                                <div class="product_box">
                                    <figure><img src="{{asset('images/product7.png')}}" alt="#"/></figure>
                                    <h3>Rams</h3>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="product_box">
                                    <figure><img src="{{asset('images/product9.png')}}" alt="#"/></figure>
                                    <h3>Drive</h3>
                                </div>
                            </div>
                            <div class="col-md-12">
                                    ...
                                    <div class="carousel-caption ">
                                        <div class="row">
                                            <div class="col-md-9 offset-md-3">
                                                <div class="test_box">
                                                    <i><img src="{{asset('images/cos.png')}}" alt="#"/></i>
                                                    <h4>Sandy Miller</h4>
