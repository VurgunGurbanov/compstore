                        ...
                        <div class="tab-content" id="custom-content-above-tabContent">
                            ...
                            @foreach(['az','en','ru'] as  $lang)
                                ...
                                <div class="tab-pane fade @if($loop->index == 0) show active @endif" id="{{$lang}}" role="tabpanel" aria-labelledby="locale-{{$lang}}">
                                    <input title="" class="form-control" type="text" name="title[{{$lang}}]" value="">
                                    <label for="desc{{$lang}}">Description ({{$lang}})</label>
                                    <textarea name="description[{{$lang}}]" id="desc{{$lang}}"  class="form-control" cols="30" rows="10" placeholder="Description {{$lang}}"></textarea>
                                </div>
                            @endforeach
